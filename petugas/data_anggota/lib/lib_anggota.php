...
class Library{
    ...
    public function addAnggota($nisn, $nama_anggota, $jenis_kelamin, $no_telp_anggota, $email_anggota, $alamat, $password) {
        ...
        if(!$query){
            echo '<script language="javascript">alert("Gagal tambah data!"); document.location="add_anggota.php"; </script>';
        }
        else {
    ...
    public function updateAnggota($id_anggota, $nisn, $nama_anggota, $jenis_kelamin, $no_telp_anggota, $email_anggota, $alamat, $password){
        $sql    = "UPDATE anggota SET nisn='$nisn', nama_anggota='$nama_anggota', jenis_kelamin='$jenis_kelamin', no_telp_anggota='$no_telp_anggota', email_anggota='$email_anggota', alamat='$alamat', password='$password' 
