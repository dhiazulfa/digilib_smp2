...
$(function () {
  ...
  <div class="header">
    <nav class="navbar navbar-expand-lg fixed-top py-3 mt-3">
        ...
        <a class="navbar-brand text-uppercase font-weight-bold">DIGILIB SMP 2 GIRITONTRO</a>
            <button type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation" class="navbar-toggler navbar-toggler-right"><i class="fa fa-bars"></i></button>
            
            <div id="navbarSupportedContent" class="collapse navbar-collapse">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active"><a href="#" class="nav-link text-uppercase font-weight-bold">Home <span class="sr-only">(current)</span></a></li>
                    <li class="nav-item"><a href="navbar.php" class="nav-link text-uppercase font-weight-bold">Dashboard</a></li>
  ...
  <div class="input-group-append">
    ...
    <div class="row col-md">
        <?php
            ...
            <a href="data_buku/data_satuan.php?id_buku='.$data->id_buku.'" class="btn btn-primary">Lihat Selengkapnya</a
    </div>
</div>
</div>
